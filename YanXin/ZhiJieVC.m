...
@interface ZhiJieVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    //[self huoQuMyFriendsPage:@"1"];
}

#pragma mark --获取直接好友数据
-(void)huoQuMyFriendsPage:(NSString*)page{
    //1.直接好友 2.间接好友3.其他好友
    [Engine ChaXunMyFriendsZhiJie:@"1" Page:page success:^(NSDictionary *dic) {
