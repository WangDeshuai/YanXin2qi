...
#import "KeJiSuanVC.h"
#import "YiHuoDeVC.h"
@interface MyCaiFuVC ()<SGTopTitleViewDelegate,UIScrollViewDelegate>
@property (nonatomic, strong) SGTopTitleView *topTitleView;
@property (nonatomic, strong) NSArray *titles;
@property (nonatomic, strong) UIScrollView *mainScrollView;
@end

@implementation MyCaiFuVC
...
- (void)viewDidLoad {
    ...
    YiHuoDeVC *oneVC = [[YiHuoDeVC alloc] init];
...
- (void)setupChildViewController {
    ...
    KeJiSuanVC *twoVC = [[KeJiSuanVC alloc] init];
