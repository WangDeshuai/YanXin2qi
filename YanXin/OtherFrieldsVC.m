...
@interface OtherFrieldsVC ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)huoQuMyFriendsPage:(NSString*)page{
    //1.直接好友 2.间接好友3.其他好友
    [Engine ChaXunMyFriendsZhiJie:@"3" Page:page success:^(NSDictionary *dic) {
